...
本仓库是基于 [原始开源项目](https://github.com/Shanyin-ai/Story-to-game) 的二次开发参赛版本，遵循原项目 MIT License。
...
- 整理线上体验入口：将单文件启动器和示例剧本部署为可直接访问的浏览器体验版，方便评委快速复现。

原始框架、启动器基础能力和 MIT 版权声明保留在仓库中；本参赛重点是基于该框架做面向黑客松场景的效率优化、流程收敛和体验包装。
